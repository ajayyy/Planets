...
public class WSServer {
	...
	public void startServer() {
		// Here we must create the server and all the behavior for the messages received
		// by the clients
			...
			public void onMessage(WebSocket arg0, String arg1) {
				...
				if (arg1.equals("MSG_REQUEST_ID")) {
					...
					if (clientId > Integer.MAX_VALUE - 50)
						clientId = 0; // -50 just in case something goes wrong before then
				} else {
					int id = -20;
					...
					if (id == -20)
						System.err.println("MESSAGE FROM PLAYER WHO HAS LEFT");
					else
						s.onMessage(arg1, id); // High level message
